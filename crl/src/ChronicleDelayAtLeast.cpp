/** ***********************************************************************************
 * \file ChronicleDelayAtLeast.cpp
...
namespace CRL 
{
  ...
  *   \param[in] d minimum duration of the chronicle
  */ 
  ChronicleDelayAtLeast::ChronicleDelayAtLeast(Chronicle* opL, const DurationType& d)
    : ChronicleDelayOp(opL,d)
  {
    // Ce(C1 at least d) = Cr(C1) \ {\bot}
    // Cr(C1 at least d) = Cr(C1) U {\bot}
  ...
  *   \return string
  */
  std::string ChronicleDelayAtLeast::toString() const
  {
  ...
  */
  bool ChronicleDelayAtLeast::process(const DateType& d, CRL::Event* e)
  {
    ...
    {
      Chronicle::RecoSet::const_iterator itL;
