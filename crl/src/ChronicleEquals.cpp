/** ***********************************************************************************
 * \file ChronicleEquals.cpp
 * \author Ariane Piel & Jean Bourrely / Onera DCPS
 * \date 2012
 * \brief Equals of two Chronicles
 **************************************************************************************/
...
namespace CRL 
{
  ...
  */  
  ChronicleEquals::ChronicleEquals(Chronicle* opL, Chronicle* opR) 
    : ChronicleBinaryOp(opL,opR)
  {
    ...
    if ( Context::contextIntersection(opLCr, opRCr).isSingletonAnonymous() )
    {
      ...
      throw("ChronicleEquals : inappropriate contexts");
  }
  ...
  *   \return string
  */
  std::string ChronicleEquals::toString() const
  {
  ...
  */
  bool ChronicleEquals::process(const DateType& d, CRL::Event* e)
  {
