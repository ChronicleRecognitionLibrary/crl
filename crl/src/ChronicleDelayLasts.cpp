...
namespace CRL 
{
  ...
  *   \param[in] d exact duration of the chronicle
  */ 
  ChronicleDelayLasts::ChronicleDelayLasts(Chronicle* opL, const DurationType& d) 
    : ChronicleDelayOp(opL,d) 
  {
    // Ce(C1 lasts d) = Cr(C1) \ {\bot}
    // Cr(C1 lasts d) = Cr(C1) U {\bot}
  ...
  */ 
  ...
  /** Display in the form : \code ((A B) == 4.0) \endcode
  *   \return string
  */
  std::string ChronicleDelayLasts::toString() const
  {
  ...
  */
  bool ChronicleDelayLasts::process(const DateType& d, CRL::Event* e)
  {
